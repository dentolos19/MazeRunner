...
public static class MazeEngine
{
    ...
    private static void CreateMesh(Matrix4x4 matrix, ref List<Vector3> vertices, ref List<Vector2> uvs, ref List<int> triangles)
    {
        ...
        var vertices1 = new Vector3(-0.5f, -0.5f, 0);
        var vertices2 = new Vector3(-0.5f, 0.5f, 0);
        var vertices3 = new Vector3(0.5f, 0.5f, 0);
        var vertices4 = new Vector3(0.5f, -0.5f, 0);
        vertices.Add(matrix.MultiplyPoint3x4(vertices1));
        vertices.Add(matrix.MultiplyPoint3x4(vertices2));
        vertices.Add(matrix.MultiplyPoint3x4(vertices3));
        vertices.Add(matrix.MultiplyPoint3x4(vertices4));
